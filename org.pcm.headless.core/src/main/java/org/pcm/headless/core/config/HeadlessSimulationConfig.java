...
public class HeadlessSimulationConfig {
	...
	public Map<String, Object> convertToConfigMap() {
		...
		configMap.put(AbstractSimulationConfig.SIMULATION_TIME, String.valueOf(this.simulationTime));
		configMap.put(AbstractSimulationConfig.MAXIMUM_MEASUREMENT_COUNT, String.valueOf(this.maximumMeasurementCount));
